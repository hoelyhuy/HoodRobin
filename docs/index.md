...
<br />
# Input
![alt text](https://github.com/hoelyhuy/HoodRobin/blob/master/docs/input_index.jpg)
# Output
![alt text](https://github.com/hoelyhuy/HoodRobin/blob/master/docs/output_index.jpg)
<br />
## Team members
Edwin Li
<br />
